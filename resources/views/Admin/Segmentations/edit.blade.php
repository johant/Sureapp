...
@section('header')
<h1 class="pull-left">
 Actualizar Segmentacion {{ $segmentation->name}}
 <small><i class="fa fa-arrow-circle-left"></i><a href="{{ route('segmentations.index') }}"> Regresar a la lista de Segmentaciones</a></small>
</h1>
@stop
@section('content')
<div class="content">
<form id="frmTicket" class="form-horizontal"" action="{{ route('segmentations.update', $segmentation->id)}}" method="post" enctype="multipart/form-data" files="true" >
    {{ csrf_field() }}
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="form-group {{ $errors->has('name') ? 'has-error': ''}}">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group input-group-required">
                                            <input class="form-control text-box single-line" id="name" name="name" type="text" value="{{ old('name', $segmentation->name)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group input-group-required">
                                            <input class="form-control text-box single-line" id="description" name="description" type="text" value="{{ old('description', $segmentation->description)}}">
                                            <div class="input-group-btn">
                                                <span class="required">*</span>
                                            </div>
                                         </div>
                                ...
                                <div class="form-group {{ $errors->has('type') ? 'has-error': ''}}">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <select name="type" id="type" class="form-control valid" >
                                            ...
                                            <option value="Licores" {{ $segmentation->type== "Licores" ? 'selected': ''}}>Licores</option>
                                            <option value="Clientes" {{ $segmentation->type== "Clientes" ? 'selected': ''}}>Clientes</option>
                                        </select>
