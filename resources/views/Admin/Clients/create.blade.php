...
@section('header')
<h1 class="pull-left">
 Adicionar un Nuevo Tipo de Cliente
 <small><i class="fa fa-arrow-circle-left"></i><a href="{{ route('clients.index') }}"> Regresar a la lista de Tipos de Clientes</a></small>
</h1>
@stop
@section('content')
<div class="content">
<form id="frmTicket" class="form-horizontal"" action="{{ route('clients.store')}}" method="post" enctype="multipart/form-data" files="true" >
    {{ csrf_field() }}
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="form-group {{ $errors->has('quantity') ? 'has-error': ''}}">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group input-group-required">
                                            <input class="form-control text-box single-line" id="quantity" name="quantity" type="number" value="{{ old('quantity')}}">
                                            <div class="input-group-btn">
                                                <span class="required">*</span>
                                            </div>
