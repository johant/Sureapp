<div id="updatesurvey-window" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="updatesurvey-window-title">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title" id="copyproduct-window-title"> Actualizar Encuesta  </h4>
            </div>
