                                ...
                                <div class="form-group {{ $errors->has('category') ? 'has-error': ''}}">
                                    <div class="col-md-3">
                                        <div class="label-wrapper">
                                            ...
                                            <div class="ico-help" title="Categoria de la encuesta"><i class="fa fa-question-circle"></i></div></div>
                                    </div>
                            ...
                            <table id="customers-table" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    @if($survey_start->status)
                                    <a class="btn btn-success" href=""><i class="fa fa-lock"></i>Cerrar Encuesta</a>
                                    @endif
                                    </td>
                                  </tr>
                                  @endforeach
