...
@section('header')
<h1 class="pull-left">
 Editar Encuesta {{ $survey->name }}
 <small><i class="fa fa-arrow-circle-left"></i><a href="{{ route('customers.index') }}"> Regresar a la lista de Encuestas</a></small>
</h1>
@stop
@section('content')
<div class="content">
    ...
    {{ csrf_field() }} {{ method_field ('PUT') }}
        <div id="customer-edit" class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a data-tab-name="tab-info" data-toggle="tab" href="#tab-info">Datos Encuesta</a></li>
                <li class=""><a data-tab-name="tab-staff" data-toggle="tab" href="#tab-staff">Preguntas</a></li>
            </ul>
