...
@section('header')
<h1 class="pull-left">
 Editar Entrenador {{ $coach->name }}
 <small><i class="fa fa-arrow-circle-left"></i><a href="{{ route('coaches.index') }}"> Regresar a la lista de Entrenadores</a></small>
</h1>
@stop
@section('content')
<div class="content">
<form id="frmTicket" class="form-horizontal"" action="{{ route('coaches.update', $coach->id)}}" method="post" enctype="multipart/form-data" files="true" >
    {{ csrf_field() }}
    {{ method_field ('PUT') }}
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="form-group {{ $errors->has('name') ? 'has-error': ''}}">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group input-group-required">
                                            <input class="form-control text-box single-line" id="name" name="name" type="text" value="{{ old('name', $coach->name )}}">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group input-group-required">
                                            <input class="form-control text-box single-line" id="document" name="document" type="text" value="{{ old('document', $coach->document)}}">
                                         </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="label-wrapper">
                                        ...
                                        <div class="input-group input-group-required">
                                         ...
                                         <select class="form-control valid" name="area_id" id="area_id">
                                            ...
                                            @foreach($areas as $area)
                                                <option value="{{ $area->id }}" {{old('area_id',  $coach->area_id ) == $area->id ? 'selected': ''}}>{{ $area->name }}</option>
                                            @endforeach
                                            </select>
                                            <div class="input-group-btn">
                                                <span class="required">*</span>
                                ...
                                <div class="form-group {{ $errors->has('email') ? 'has-error': ''}}">
                                    ...
                                    <div class="col-md-9">
                                    <div class="input-group input-group-required">
                                       <input class="form-control text-box single-line" id="email" name="email" type="email" value="{{ old('email', $coach->email)}}">
                                        <div class="input-group-btn">
                                            <span class="required">*</span>
                                        </div>
